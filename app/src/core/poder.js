...
function getGlobalMultipliers(ficha) {
    try {
        ...
        // Réplica exata do mesmo bloco em Ficha Def/Marcados.jsx > getGlobalMultipliers, pra este
        // cálculo (reaproveitado pelo Mapa etc.) nunca divergir do que o Scouter mostra.
